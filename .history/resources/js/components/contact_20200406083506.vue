 ...
 <div class="card-header"><h3>Solicitud De Pelicula</h3></div>
              <form @submit.prevent="submit">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pelicula" id="pelicula" v-model="fields.pelicula"  required />
                    <div v-if="errors && errors.pelicula" class="text-danger">{{ errors.pelicula[0] }}</div>
                </div>
                
                <div class="form-group">
                    <label for="message">Description</label>
                    <textarea class="form-control" id="message" name="message" rows="5" v-model="fields.message"  required></textarea>
