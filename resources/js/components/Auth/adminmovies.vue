      ...
      <div class="container">
        <div class="row">
          <div class="mov" v-for="movie in movies" :key="movie.id">
            <div class="cardc">
              <img class="card-img-top" :src="movie.image" v-if="movie.image" />
              ...
              <div class="card-body">
                ...
                <div class="card-button">
                  <button class="btn btn-outline-info btn-sm">
                    ...
                    <a :href="`${movie.link_trailer}`" target="_blank">VER TRAILER</a>
                  </button>
                </div>
                <router-link
                  :to="{name: 'singleFilm', params: {slug: movie.id} }"
                  tag="button"
            ...
            <nav aria-label="...">
              <ul class="pagination justify-content-center">
                <li
                  ...
                  <span
                    @click="getMovies(pagination.prev_page_url)"
                    class="page-link"
                  >Previous</span>
                </li>
                <li
                ...
                >
                  <span
                    class="page-link"
                    @click=" getMovies(fetch_url +'api/movies?page=' + page) "
                  >{{ page }}</span>
                </li>
                <li
                  class="page-item"
                  ...
                  <span
                    @click="getMovies(pagination.next_page_url)"
                    class="page-link"
                  >Next</span>
                </li>
              </ul>
